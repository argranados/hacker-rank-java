...
//        else return false
        ...
        SinglyLinkedListNode q1Node = head1;
        SinglyLinkedListNode q2Node = head2;

        while(q1Node.data == q2Node.data){
                if (q1Node.next!=null && q2Node.next!=null) {
                    q1Node = q1Node.next;
                    q2Node = q2Node.next;
                }
                else
                    if((q1Node.next==null)&&(q1Node.next==null))
                        return true;
                    else
                        return false;
            }
